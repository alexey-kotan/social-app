...
<div class="w-7/12 mx-auto">
  <p class="d-flex mt-16 mb-2"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-shield-lock" viewBox="0 0 16 16">
  ...
  {{-- autocomplete - браузер не дает отправить форму, если поля не заполненны --}}
    ...
    <div class="form-floating">
      ...
      {{-- если в сессии есть status(успешная отправка из forgotcontroller), то отобразить сообщение --}}
        <span class="badge bg-success-subtle text-success-emphasis rounded-pill mt-4 mb-2">Успешно! Сообщение о воосстановлении пароля отправленна вам на почту.</span>
      @endif
    </div>
