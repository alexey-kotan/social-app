...
<div class="col-md-12">
  <div class="bg-white row border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-350 position-relative">
    ...
    @if($post->likes > 0)
      <form action="{{ route('post_likes', $post->id) }}" method="GET">
        <button class="ml-2 mb-2 d-flex align-items-center"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-heart mr-2" viewBox="0 0 16 16">
